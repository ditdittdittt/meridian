...
export const config = {
  ...
  screening: {
    ...
    // Hard ceiling on accepted pool volatility. null = no ceiling (default).
    // Set to a positive number, or let lessons.js evolveThresholds() lower it
    // automatically when loser positions cluster at high volatility.
